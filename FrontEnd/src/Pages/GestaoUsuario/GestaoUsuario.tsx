...
import { Search, SlidersHorizontal, Plus, ChevronDown, ChevronLeft, ChevronRight, Edit, Trash2, LogOut, Eye, LayoutDashboard, Users, FileText, BarChart, Settings, Key } from 'lucide-react';
        ...
        if (action === 'edit') {
            ...
            content = (
                <form className={styles.form}>
                    <input type="text" placeholder="Nome" defaultValue={user.nome} required />
                    <input type="text" placeholder="Cargo" defaultValue={user.cargo} required />
                    <input type="text" placeholder="Número" defaultValue={user.numero} required />
            ...
            content = (
                <div>
                    <p>Tem certeza que deseja excluir o usuário <strong>{user.nome}</strong>? Esta ação é irreversível.</p>
                    <div className={styles.modalActions}>
                        <button type="button" className={styles.button} onClick={onClose}>
                            Cancelar
                        </button>
...
function GestaoUsuarios(): JSX.Element {
    ...
    const paginate = (pageNumber: number) => console.log('Paginar para', pageNumber); // Funções de paginação simplificadas
                                        ...
                                        <tr key={user.id}>
                                            ...
                                            <td className={styles.actionsCell}>
                                                ...
                                                <Key 
                                                    size={16} 
                                                    className={styles.actionIcon}
                                                    onClick={() => openActionModal(user, 'changePassword')}
                                                />
                                                <Trash2 
                                                    size={16} 
