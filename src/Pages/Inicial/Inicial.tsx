...
import { 
  ...
  Plus, FileText, Calendar, Clock, ChevronDown, User, AlertCircle, X 
} from 'lucide-react';
...
function Inicial(): JSX.Element {
  ...
  return (
    <>
      <div className={`${styles.appContainer} ${isModalOpen ? styles.blurBackground : ''}`}>
        ...
        <div className={styles.mainContent}>
          <div className={styles.dashboardGrid}>
            ...
            <div className={styles.actionCards}>
              ...
              <div className={styles.actionCard} onClick={() => handleCardClick('Registrar ocorrência')}>
              ...
              <div className={styles.actionCard} onClick={() => handleCardClick('Gerenciar usuários')}>
                <div className={styles.cardIconCircle}>
              ...
              <div className={styles.actionCard} onClick={() => handleCardClick('Gerar relatório diário')}>
                <div className={styles.cardIconCircle}>
      ...
      {isModalOpen && (
        <div className={styles.modalOverlay} onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className={styles.modalTitle}>Formulário de {modalActionType}</h3>
            
            <div className={styles.modalBody}>
              <p>O formulário para **{modalActionType}** irá aqui.</p>
              <input type="text" placeholder="Insira a informação..." className={styles.modalInput} />
            </div>
